...
def play():
    global flip
    # Preload backgrounds for level 1 and level 2
    ...
    while True:
        ...
        player_pos += movement * player_speed
        # Clamp player within screen (200x200 sprite)
        ...
        if enemies:
            ...
            for arrow in arrows[:]:
                arrow.update()
                if (arrow.pos.x < 0 or arrow.pos.x > width or 
